...
class HomeController extends Controller
{
    public function product_auth(){
     $prod=   Product::whereIn('user_id', verified_sellers_id())->get();
        dd($prod);
    }
    ...
    public function testt(){
        dd(Product::withTrashed()->find(22));
    }
...
$top10_brands = json_decode(get_setting('top10_brands'));
    ...
    public function load_featured_section(){
        $fetures = Product::where('published', 1)->where('featured', '1')->limit(12)->get();
        return view('frontend.partials.featured_products_section', compact('fetures'));
    }

    public function load_best_selling_section(){
        $products =Product::where('published', 1)->orderBy('num_of_sale', 'desc')->limit(12)->get();
    ...
    public function load_best_sellers_section(){
        ...
        return view('frontend.partials.best_sellers_section', compact('sellers'));
    }
