...
class ProductController extends BaseController
{
    ...
    {
        $products['data'] = Product::whereIn('user_id', verified_sellers_id())->latest()->get();
    ...
    {
        $product['data'] = Product::where('user_id', verified_sellers_id())->find($id);
        if ($product['data']) {
    ...
    {
        $products['data'] = Product::whereIn('user_id', verified_sellers_id())->where('added_by', 'seller')->latest()->get();
        if ($products['data']->count() > 0) {
            $products['data'] = ProductResource::collection($products['data']);
        }
    ...
    public function category($id)
    {
        ...
        $category_ids[] = $id;
        $cat['data'] = ProductResource::collection(Product::whereIn('user_id', verified_sellers_id())->whereIn('category_id', $category_ids)->latest()->get());
    ...
    public function subCategory($id)
    {
        ...
        if ($category_ids) {
            $category_ids[] = $id;
            $products = Product::whereIn('user_id', verified_sellers_id())->whereIn('category_id', $category_ids)->latest()->get();
            if ($products->count() > 0) {
    ...
    {
        $products['data'] = Product::whereIn('user_id', verified_sellers_id())->where('brand_id', $id)->latest()->get();
        if ($products['data']->count() > 0) {
    ...
    {
        $products['data'] = Product::whereIn('user_id', verified_sellers_id())->where('todays_deal', '1')->latest()->get();
        if ($products['data']->count() > 0) {
            $products['data'] = ProductResource::collection($products['data']);
        }
    ...
    {
        $fetured['data'] = ProductResource::collection(Product::whereIn('user_id', verified_sellers_id())->where('featured', 1)->latest()->get());
        return $this->sendResponse($fetured, translate('featured'));
    }

    public function bestSeller()
    {
        $best['data'] = ProductResource::collection(Product::whereIn('user_id', verified_sellers_id())->orderBy('num_of_sale', 'desc')->limit(20)->get());
    ...
    public function related($id)
    {
        ...
        $related['data'] = ProductResource::collection(Product::whereIn('user_id', verified_sellers_id())->where('category_id', $product->category_id)->where('id', '!=', $id)->limit(10)->get());
    ...
    {
        $product = Product::find($id);
        $related['data'] = ProductResource::collection(Product::whereIn('user_id', verified_sellers_id())->where('user_id', $product->user_id)->orderBy('num_of_sale', 'desc')->limit(4)->get());
    ...
    public function search(Request $request)
    {
        ...
        $key = $request->key;
        $scope = $request->scope;
        $products = Product::whereIn('user_id', verified_sellers_id())->where('name', 'like', "%{$key}%")->orWhere('name_ar', 'like', "%{$key}%")->orWhere('tags', 'like', "%{$key}%");
        if ($products->count() > 0) {
            switch ($scope) {
                case 'price_low_to_high':
                    $collection['data'] = SearchProductResource::collection($products->whereIn('user_id', verified_sellers_id())->orderBy('unit_price', 'asc')->get());
                    return $this->sendResponse($collection, translate('price_low_to_high'));
                case 'price_high_to_low':
                    $collection['data'] = SearchProductResource::collection($products->whereIn('user_id', verified_sellers_id())->orderBy('unit_price', 'desc')->get());
                    return $this->sendResponse($collection, translate('price_high_to_low'));
                case 'new_arrival':
                    $collection['data'] = SearchProductResource::collection($products->whereIn('user_id', verified_sellers_id())->orderBy('created_at', 'desc')->get());
                    return $this->sendResponse($collection, translate('new_arrival'));
                case 'popularity':
                    $collection['data'] = SearchProductResource::collection($products->whereIn('user_id', verified_sellers_id())->orderBy('num_of_sale', 'desc')->get());
                    return $this->sendResponse($collection, translate('popularity'));
                case 'top_rated':
                    $collection['data'] = SearchProductResource::collection($products->whereIn('user_id', verified_sellers_id())->orderBy('rating', 'desc')->get());
